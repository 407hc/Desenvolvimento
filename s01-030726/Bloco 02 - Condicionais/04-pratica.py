...
# 8. Tomada de Decisão (Condicional) com "elif"
if valor_contrato <= valor_contrato_ideal:
    print("Veredito: Contrato Aprovado!")
elif vitorias >= vitorias_ideal:
    print("Veredito: Enviar para Análise da Diretoria (Preço alto, mas joga muito).")
else:
    print("Veredito: Contrato Recusado!")
